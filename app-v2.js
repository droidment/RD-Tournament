    ...
    document.getElementById('login-view').innerHTML = `
        <div class="max-w-md mx-auto mt-8 sm:mt-12 fade-in">
            <div class="bg-white rounded-lg shadow-xl p-6 sm:p-8">
                ...
                <button id="google-login-btn" class="w-full bg-white border-2 border-gray-300 text-gray-700 py-3 rounded-lg font-semibold hover:bg-gray-50 transition flex items-center justify-center gap-2 mb-6">
                ...
                <div class="mt-6 p-4 bg-blue-50 rounded-lg text-sm text-gray-700">
                    ...
                    <ul class="text-xs space-y-1 ml-4 list-disc">
                        <li>Easiest: Use "Sign in with Google" button above</li>
                        <li>Or enter your registered email and create a password</li>
